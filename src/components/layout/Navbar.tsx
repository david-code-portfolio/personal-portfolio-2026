...
function Navbar(){
    return(
        <nav className="fixed top-8 left-1/2 -translate-x-1/2 bg-bg-surface pl-8 pr-2 py-2 max-sm:py-4 max-sm:px-6 items-center w-fit rounded-lg flex gap-8 max-sm:min-w-[100px] max-sm:w-4/5 max-sm:justify-between">
